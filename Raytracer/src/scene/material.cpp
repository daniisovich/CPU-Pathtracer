...
Material::Material(const Vec3& color, float reflectiveness, float fuzziness, BRDFFunction brdf) : m_color{ color }, m_reflectiveness{ reflectiveness }, m_fuzziness{ fuzziness }, m_brdf{ brdf } { }
